webpackJsonp([1, 0], [function (e, t, a) {
    ...
    var z = t.secretary = new S("assistant_secretary", "Personal Secretary", "工作经验 +50%", 500, function () {
            return !0
        }, function () {
            return !0
        }),
    ...
    for (var F = [], Y = 1; Y < 8; Y++) {
        var J = 10,
            U = new S("assistant_ai_research_" + Y, "AI Research Assistant " + Y, "研究速度 +" + J + "%", 50 * Y, function () {
                return !0
            }, function () {
                return !0
            }),
